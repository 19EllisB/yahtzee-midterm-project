 ...
 */
public enum ScoreLabel //Names of the categories on a score sheet. 18 total
{
    ACES ("Aces"),
    ...
    ScoreLabel(String name) { //Constructor: Possible because each constant is its own class.
        this.name = name;
    }
